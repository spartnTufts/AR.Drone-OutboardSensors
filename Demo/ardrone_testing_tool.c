...
#include <ardrone_tool/Sendata/ardrone_sendata_client.h> //custom
...
C_RESULT ardrone_tool_init_custom(int argc, char **argv)
{
  ...
  //Sendata
  ardrone_sendata_client_init();
  START_THREAD( sendata_update, NULL );
...
BEGIN_THREAD_TABLE
  ...
  THREAD_TABLE_ENTRY( sendata_update, 20 ) //custom
END_THREAD_TABLE
